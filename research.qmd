...
`r bt("http://arxiv.org/abs/2603.24538", "Preprint", "far fa-file-pdf")`

Septiandri, A., **Ming, D.**, DiazDelaO, F. A., Jendoubi, T., and Ray S. (2025) Integrative analysis and imputation of multiple data streams via deep Gaussian processes. *Bioinformatics Advances*.
